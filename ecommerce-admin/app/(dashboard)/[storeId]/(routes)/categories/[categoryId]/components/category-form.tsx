...
export const CategoryForm: React.FC<CategoryFormProps> = ({
  ...
  const onSubmit = async (data: CategoryFormValues) => {
    try {
      ...
      console.log(error);
      toast.error(`Houve um erro ao salvar a categoria. ${error}`);
    } finally {
      setLoading(false);
    }
  };
  ...
  const onDelete = async () => {
    try {
      ...
      toast.error(
        "Erro ao excluir a categoria. Verifique se há algum produto utilizando esta categoria."
      );
    } finally {
      setLoading(false);
      setOpen(false);
                  ...
                  >
                    <FormControl>
                      <SelectTrigger>
                        <SelectValue
                          defaultValue={field.value}
                          placeholder="Selecione uma publicidade"
                        ></SelectValue>
                      </SelectTrigger>
                    </FormControl>
                    <SelectContent>
